...
<qgis minScale="2e+06" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="100000" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{0ec15e98-93bd-4d6f-bca2-47602eb3656d}">
      <rule key="{bf1c1041-b95d-4ce0-b95d-870a5b3b1ea2}" scalemindenom="100001" scalemaxdenom="2000001" symbol="0"/>
      <rule key="{2c12f185-8d3a-4f2e-8543-f1495338bc15}" scalemindenom="1" scalemaxdenom="100001" symbol="1"/>
    </rules>
    <symbols>
      <symbol name="0" type="fill" force_rhr="0" alpha="0.498039" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="25,237,78,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="39,235,85,255" k="outline_color"/>
      ...
      <symbol name="1" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          ...
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="128,255,64,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" fontKerning="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOpacity="1" useSubstitutions="0" isExpression="0" fontItalic="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" multilineHeight="1" fontSizeUnit="Point" fontUnderline="0" fontWordSpacing="0" textColor="55,203,79,255" fontWeight="50" fontSize="12" namedStyle="Italic" fieldName="TOPONYME" fontFamily="Calibri" textOrientation="horizontal" fontLetterSpacing="0">
        <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferSize="1.5" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="255,255,255,255" bufferSizeUnits="Point" bufferDraw="1" bufferOpacity="1"/>
      ...
      <rendering fontMaxPixelSize="10000" mergeLines="0" limitNumLabels="0" obstacle="1" scaleVisibility="1" labelPerPart="0" obstacleFactor="1" drawLabels="1" minFeatureSize="0" scaleMax="2000001" obstacleType="0" fontLimitPixelSize="0" maxNumLabels="2000" zIndex="0" fontMinPixelSize="3" scaleMin="100001" upsidedownLabels="0" displayAll="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
