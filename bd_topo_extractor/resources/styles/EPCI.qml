...
<qgis minScale="600001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="100001" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
    ...
    <symbols>
      <symbol name="0" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          ...
          <prop v="214,205,104,0" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,190,255,255" k="outline_color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement maxCurvedCharAngleOut="-20" overrunDistanceUnit="MM" maxCurvedCharAngleIn="20" repeatDistanceUnits="MM" preserveRotation="1" distUnits="MM" overrunDistance="0" layerType="PolygonGeometry" geometryGenerator="" geometryGeneratorType="PointGeometry" placementFlags="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" repeatDistance="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" centroidInside="0" offsetType="0" offsetUnits="MapUnit" dist="0" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidWhole="0"/>
      <rendering fontMaxPixelSize="10000" mergeLines="0" limitNumLabels="0" obstacle="1" scaleVisibility="1" labelPerPart="0" obstacleFactor="1" drawLabels="1" minFeatureSize="0" scaleMax="500001" obstacleType="0" fontLimitPixelSize="0" maxNumLabels="2000" zIndex="0" fontMinPixelSize="3" scaleMin="100001" upsidedownLabels="0" displayAll="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penColor="#000000" rotationOffset="270" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" enabled="0" lineSizeType="MM" backgroundAlpha="255" width="15" sizeScale="3x:0,0,0,0,0,0" penAlpha="255" backgroundColor="#ffffff" barWidth="5" scaleDependency="Area" scaleBasedVisibility="1" maxScaleDenominator="800001" penWidth="0" labelPlacementMethod="XHeight" minimumSize="0" minScaleDenominator="100000" height="15" opacity="1" diagramOrientation="Up">
