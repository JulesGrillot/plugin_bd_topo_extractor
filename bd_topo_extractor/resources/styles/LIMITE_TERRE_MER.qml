...
<qgis minScale="1e+08" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0">
    ...
    <symbols>
      <symbol name="0" type="line" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="94,142,186,255" k="line_color"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="TYPE_LIMIT" type="field" width="-1" hidden="0"/>
      <column name="NIVEAU" type="field" width="-1" hidden="0"/>
  ...
  <editable>
    ...
    <field name="TYPE_LIMIT" editable="1"/>
  </editable>
  <labelOnTop>
    ...
    <field name="TYPE_LIMIT" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
