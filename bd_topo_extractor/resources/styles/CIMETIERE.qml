...
<qgis minScale="25000" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
        ...
        <layer enabled="1" pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol name="@0@1" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
              ...
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
              <prop v="105,105,105,255" k="outline_color"/>
              <prop v="solid" k="outline_style"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penColor="#000000" rotationOffset="270" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" enabled="0" lineSizeType="MM" backgroundAlpha="255" width="15" sizeScale="3x:0,0,0,0,0,0" penAlpha="255" backgroundColor="#ffffff" barWidth="5" scaleDependency="Area" scaleBasedVisibility="1" maxScaleDenominator="25000" penWidth="0" labelPlacementMethod="XHeight" minimumSize="0" minScaleDenominator="inf" height="15" opacity="1" diagramOrientation="Up">
