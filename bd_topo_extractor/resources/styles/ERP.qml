...
<qgis minScale="1001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="0" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format addDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3" wrapChar="" multilineAlign="3" autoWrapLength="0" formatNumbers="0" plussign="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" placeDirectionSymbol="0"/>
      <placement maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" preserveRotation="1" distUnits="MM" overrunDistance="0" layerType="PointGeometry" geometryGenerator="" geometryGeneratorType="PointGeometry" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="7" repeatDistance="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" centroidInside="0" offsetType="0" offsetUnits="Point" dist="0" yOffset="4" geometryGeneratorEnabled="0" rotationAngle="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidWhole="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="ID_REF" type="field" width="-1" hidden="0"/>
      <column name="CATEGORIE" type="field" width="-1" hidden="0"/>
      <column name="TYPE_1" type="field" width="-1" hidden="0"/>
      <column name="TYPE_2" type="field" width="-1" hidden="0"/>
      <column name="ACTIV_1" type="field" width="-1" hidden="0"/>
      <column name="ACTIV_2" type="field" width="-1" hidden="0"/>
      ...
      <column name="PUBLIC" type="field" width="-1" hidden="0"/>
      <column name="OUVERT" type="field" width="-1" hidden="0"/>
      <column name="CAP_ACC" type="field" width="-1" hidden="0"/>
      <column name="CAP_HEBERG" type="field" width="-1" hidden="0"/>
      <column name="ORIGIN_GEO" type="field" width="-1" hidden="0"/>
      <column name="TYPE_LOC" type="field" width="-1" hidden="0"/>
      <column name="VALID_IGN" type="field" width="-1" hidden="0"/>
      <column name="CODE_INSEE" type="field" width="-1" hidden="0"/>
      <column name="SIRET" type="field" width="-1" hidden="0"/>
      <column name="ADR_NUMERO" type="field" width="-1" hidden="0"/>
      <column name="ADR_REP" type="field" width="-1" hidden="0"/>
      <column name="ADR_COMPL" type="field" width="-1" hidden="0"/>
      <column name="ADR_NOM_1" type="field" width="-1" hidden="0"/>
      <column name="ADR_NOM_2" type="field" width="-1" hidden="0"/>
      <column name="CODE_POST" type="field" width="-1" hidden="0"/>
      <column name="ID_BATI" type="field" width="-1" hidden="0"/>
      <column name="ID_ENCEINT" type="field" width="-1" hidden="0"/>
  ...
  <editable>
    ...
    <field name="ACTIV_1" editable="1"/>
    <field name="ACTIV_2" editable="1"/>
    <field name="ADR_COMPL" editable="1"/>
    <field name="ADR_NOM_1" editable="1"/>
    <field name="ADR_NOM_2" editable="1"/>
    <field name="ADR_NUMERO" editable="1"/>
    <field name="ADR_REP" editable="1"/>
    <field name="CAP_ACC" editable="1"/>
    <field name="CAP_HEBERG" editable="1"/>
    ...
    <field name="ID_BATI" editable="1"/>
    <field name="ID_ENCEINT" editable="1"/>
    <field name="ID_REF" editable="1"/>
    <field name="ID_SOURCE" editable="1"/>
    <field name="LIBELLE" editable="1"/>
    <field name="ORIGIN_GEO" editable="1"/>
    <field name="OUVERT" editable="1"/>
    <field name="PREC_PLANI" editable="1"/>
    <field name="PUBLIC" editable="1"/>
    <field name="SIRET" editable="1"/>
    <field name="SOURCE" editable="1"/>
    <field name="TYPE_1" editable="1"/>
    <field name="TYPE_2" editable="1"/>
    <field name="TYPE_LOC" editable="1"/>
    <field name="VALID_IGN" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="ACQU_PLANI" labelOnTop="0"/>
    <field name="ACTIV_1" labelOnTop="0"/>
    <field name="ACTIV_2" labelOnTop="0"/>
    <field name="ADR_COMPL" labelOnTop="0"/>
    <field name="ADR_NOM_1" labelOnTop="0"/>
    <field name="ADR_NOM_2" labelOnTop="0"/>
    <field name="ADR_NUMERO" labelOnTop="0"/>
    <field name="ADR_REP" labelOnTop="0"/>
    <field name="CAP_ACC" labelOnTop="0"/>
    <field name="CAP_HEBERG" labelOnTop="0"/>
    ...
    <field name="ID_BATI" labelOnTop="0"/>
    <field name="ID_ENCEINT" labelOnTop="0"/>
    <field name="ID_REF" labelOnTop="0"/>
    <field name="ID_SOURCE" labelOnTop="0"/>
    <field name="LIBELLE" labelOnTop="0"/>
    <field name="ORIGIN_GEO" labelOnTop="0"/>
    <field name="OUVERT" labelOnTop="0"/>
    <field name="PREC_PLANI" labelOnTop="0"/>
    <field name="PUBLIC" labelOnTop="0"/>
    <field name="SIRET" labelOnTop="0"/>
    <field name="SOURCE" labelOnTop="0"/>
    <field name="TYPE_1" labelOnTop="0"/>
    <field name="TYPE_2" labelOnTop="0"/>
    <field name="TYPE_LOC" labelOnTop="0"/>
    <field name="VALID_IGN" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
