...
<qgis minScale="1e+08" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="CODE_BH" type="field" width="-1" hidden="0"/>
      <column name="COMMENT" type="field" width="-1" hidden="0"/>
      <column name="ORIGINE" type="field" width="-1" hidden="0"/>
      <column name="B_FLUVIAL" type="field" width="-1" hidden="0"/>
      ...
      <column name="BASS_HYDRO" type="field" width="-1" hidden="0"/>
  ...
  <editable>
    ...
    <field name="BASS_HYDRO" editable="1"/>
    <field name="B_FLUVIAL" editable="1"/>
    <field name="CODE_BH" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="BASS_HYDRO" labelOnTop="0"/>
    <field name="B_FLUVIAL" labelOnTop="0"/>
    <field name="CODE_BH" labelOnTop="0"/>
