...
<qgis minScale="250001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="0" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
    ...
    <symbols>
      <symbol name="0" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          ...
          <prop v="140,60,0,255" k="outline_color"/>
  ...
  <labeling type="rule-based">
    <rules key="{001f18b7-0526-4a39-8809-6f1861c83064}">
      <rule key="{79e82ed4-ac11-4cd2-b995-07e4e548a335}" filter=" &quot;NATURE&quot;  =  'Ile' " scalemindenom="25001" scalemaxdenom="250001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontKerning="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOpacity="1" useSubstitutions="0" isExpression="0" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" multilineHeight="1" fontSizeUnit="Point" fontUnderline="0" fontWordSpacing="0" textColor="0,0,0,255" fontWeight="50" fontSize="11.5" namedStyle="Regular" fieldName="TOPONYME" fontFamily="Calibri" textOrientation="horizontal" fontLetterSpacing="0">
            <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferSize="2" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="255,255,255,255" bufferSizeUnits="Pixel" bufferDraw="1" bufferOpacity="1"/>
          ...
          <placement maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" preserveRotation="1" distUnits="MM" overrunDistance="0" layerType="PointGeometry" geometryGenerator="" geometryGeneratorType="PointGeometry" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" repeatDistance="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="6" centroidInside="0" offsetType="0" offsetUnits="MapUnit" dist="0" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidWhole="0"/>
          <rendering fontMaxPixelSize="10000" mergeLines="0" limitNumLabels="0" obstacle="0" scaleVisibility="0" labelPerPart="0" obstacleFactor="1" drawLabels="1" minFeatureSize="0" scaleMax="10000000" obstacleType="0" fontLimitPixelSize="0" maxNumLabels="2000" zIndex="0" fontMinPixelSize="3" scaleMin="1" upsidedownLabels="0" displayAll="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
      ...
      <rule key="{353a7cf3-91a5-43bc-bbfe-510d888c2436}" scalemindenom="1" scalemaxdenom="25001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontKerning="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOpacity="1" useSubstitutions="0" isExpression="0" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" multilineHeight="1" fontSizeUnit="Point" fontUnderline="0" fontWordSpacing="0" textColor="140,60,0,255" fontWeight="50" fontSize="10" namedStyle="Regular" fieldName="TOPONYME" fontFamily="Calibri" textOrientation="horizontal" fontLetterSpacing="0">
          ...
          <text-format addDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3" wrapChar="" multilineAlign="3" autoWrapLength="0" formatNumbers="0" plussign="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" placeDirectionSymbol="0"/>
          <placement maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" preserveRotation="1" distUnits="MM" overrunDistance="0" layerType="PointGeometry" geometryGenerator="" geometryGeneratorType="PointGeometry" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" repeatDistance="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="6" centroidInside="0" offsetType="0" offsetUnits="MM" dist="0" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidWhole="0"/>
