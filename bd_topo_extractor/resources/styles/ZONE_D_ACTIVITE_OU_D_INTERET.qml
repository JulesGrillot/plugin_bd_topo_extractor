...
<qgis minScale="10001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 symbollevels="0" type="categorizedSymbol" forceraster="0" attr="CATEGORIE" enableorderby="0">
    <categories>
      <category render="true" value="Administratif ou militaire" label="Administratif ou militaire" symbol="0"/>
      <category render="true" value="Culture et loisirs" label="Culture et loisirs" symbol="1"/>
      <category render="true" value="Gestion des eaux" label="Gestion des eaux" symbol="2"/>
      <category render="true" value="Industriel et commercial" label="Industriel et commercial" symbol="3"/>
      <category render="true" value="Religieux" label="Religieux" symbol="4"/>
      <category render="true" value="Santé" label="Santé" symbol="5"/>
      <category render="true" value="Science et enseignement" label="Science et enseignement" symbol="6"/>
      <category render="true" value="Sport" label="Sport" symbol="7"/>
    </categories>
    <symbols>
      <symbol name="0" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="70,95,15,255" k="color"/>
      ...
      <symbol name="6" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="255,115,255,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering fontMaxPixelSize="10000" mergeLines="0" limitNumLabels="0" obstacle="1" scaleVisibility="1" labelPerPart="0" obstacleFactor="1" drawLabels="1" minFeatureSize="0" scaleMax="5001" obstacleType="0" fontLimitPixelSize="0" maxNumLabels="2000" zIndex="0" fontMinPixelSize="3" scaleMin="1" upsidedownLabels="0" displayAll="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="ID_BAN" type="field" width="-1" hidden="0"/>
      <column name="NOMCOMMERC" type="field" width="-1" hidden="0"/>
  ...
  <editable>
    ...
    <field name="NOMCOMMERC" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="NOMCOMMERC" labelOnTop="0"/>
