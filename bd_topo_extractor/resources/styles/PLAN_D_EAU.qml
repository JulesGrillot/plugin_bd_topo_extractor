...
<qgis minScale="160001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <labeling type="rule-based">
    <rules key="{a001ba7a-9cbd-448d-82ec-8fd1f26c788a}">
      <rule key="{0dfbd195-0f8d-4205-a2b5-8e1b7dd44307}" filter="$area > 100000" scalemindenom="25001" scalemaxdenom="160001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontKerning="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOpacity="1" useSubstitutions="0" isExpression="0" fontItalic="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" multilineHeight="1" fontSizeUnit="Point" fontUnderline="0" fontWordSpacing="0" textColor="49,122,177,255" fontWeight="75" fontSize="13" namedStyle="Bold Italic" fieldName="TOPONYME" fontFamily="Calibri" textOrientation="horizontal" fontLetterSpacing="0">
            <text-buffer bufferJoinStyle="64" bufferBlendMode="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="255,255,255,255" bufferSizeUnits="MM" bufferDraw="1" bufferOpacity="1"/>
      ...
      <rule key="{7783d92a-768d-4fbc-b8ba-20921994753c}" scalemindenom="1" scalemaxdenom="25001">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontKerning="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOpacity="1" useSubstitutions="0" isExpression="0" fontItalic="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" multilineHeight="1" fontSizeUnit="Point" fontUnderline="0" fontWordSpacing="0" textColor="49,122,177,255" fontWeight="75" fontSize="13" namedStyle="Bold Italic" fieldName="TOPONYME" fontFamily="Calibri" textOrientation="horizontal" fontLetterSpacing="0">
            <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferColor="255,255,255,255" bufferSizeUnits="MM" bufferDraw="0" bufferOpacity="1"/>
            <background shapeFillColor="255,255,255,255" shapeBorderColor="128,128,128,255" shapeDraw="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeBlendMode="0" shapeSizeUnit="MM" shapeRotation="0" shapeOffsetY="0" shapeOffsetX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRadiiX="0" shapeSizeY="0" shapeBorderWidth="0" shapeRadiiUnit="MM" shapeOpacity="1" shapeRadiiY="0" shapeRotationType="0" shapeSizeType="0" shapeSVGFile="" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0">
              <symbol name="markerSymbol" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
                <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
                  <prop v="0" k="angle"/>
          ...
          <text-format addDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3" wrapChar="" multilineAlign="0" autoWrapLength="0" formatNumbers="0" plussign="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" placeDirectionSymbol="0"/>
          <placement maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" preserveRotation="1" distUnits="MM" overrunDistance="0" layerType="PolygonGeometry" geometryGenerator="" geometryGeneratorType="PointGeometry" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" repeatDistance="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" centroidInside="0" offsetType="0" offsetUnits="MM" dist="0" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidWhole="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="MAREE" type="field" width="-1" hidden="0"/>
      <column name="PERMANENT" type="field" width="-1" hidden="0"/>
      <column name="Z_MOY" type="field" width="-1" hidden="0"/>
      <column name="REF_Z_MOY" type="field" width="-1" hidden="0"/>
      <column name="MODE_Z_MOY" type="field" width="-1" hidden="0"/>
      <column name="PREC_Z_MOY" type="field" width="-1" hidden="0"/>
      <column name="HAUT_MAX" type="field" width="-1" hidden="0"/>
      <column name="OBT_HT_MAX" type="field" width="-1" hidden="0"/>
  ...
  <labelOnTop>
    ...
    <field name="HAUT_MAX" labelOnTop="0"/>
    <field name="ID" labelOnTop="0"/>
    <field name="ID_SOURCE" labelOnTop="0"/>
    <field name="IMPORTANCE" labelOnTop="0"/>
    <field name="MAREE" labelOnTop="0"/>
    <field name="MODE_Z_MOY" labelOnTop="0"/>
    <field name="NATURE" labelOnTop="0"/>
    <field name="OBT_HT_MAX" labelOnTop="0"/>
    <field name="PERMANENT" labelOnTop="0"/>
    <field name="PREC_Z_MOY" labelOnTop="0"/>
    <field name="REF_Z_MOY" labelOnTop="0"/>
