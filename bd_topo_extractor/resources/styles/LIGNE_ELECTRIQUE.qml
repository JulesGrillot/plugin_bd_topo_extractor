...
<qgis minScale="100001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
    ...
    <symbols>
      <symbol name="0" type="line" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="204,0,204,255" k="line_color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" fontKerning="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOpacity="1" useSubstitutions="0" isExpression="0" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" multilineHeight="1" fontSizeUnit="Point" fontUnderline="0" fontWordSpacing="0" textColor="204,0,204,255" fontWeight="50" fontSize="9" namedStyle="Regular" fieldName="VOLTAGE" fontFamily="Calibri" textOrientation="horizontal" fontLetterSpacing="0">
        <text-buffer bufferJoinStyle="64" bufferBlendMode="0" bufferSize="2" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="255,255,255,255" bufferSizeUnits="Point" bufferDraw="1" bufferOpacity="1"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="VOLTAGE" type="field" width="-1" hidden="0"/>
