...
<qgis minScale="100001" version="3.10.9-A Coruña" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" maxScale="0" simplifyLocal="1" labelsEnabled="1" hasScaleBasedVisibilityFlag="1">
  <flags>
    ...
    <rules key="{9f74c6b7-5503-40dd-9662-0a4da5aee340}">
      <rule key="{8bd17dbd-6740-4102-87c1-773104be968b}" filter="&quot;TYPE_ROUTE&quot;  &lt;> 'Bac'  and &quot;TYPE_ROUTE&quot;  &lt;> 'Liaison maritime' " scalemindenom="1" scalemaxdenom="50001">
        <settings calloutType="simple">
          ...
          <text-format addDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="0" wrapChar="" multilineAlign="4294967295" autoWrapLength="0" formatNumbers="0" plussign="1" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" placeDirectionSymbol="0"/>
          <placement maxCurvedCharAngleOut="-25" overrunDistanceUnit="RenderMetersInMapUnits" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" preserveRotation="1" distUnits="Point" overrunDistance="500" layerType="LineGeometry" geometryGenerator="" geometryGeneratorType="PointGeometry" placementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" repeatDistance="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="3" centroidInside="0" offsetType="0" offsetUnits="MapUnit" dist="2" yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" centroidWhole="0"/>
          <rendering fontMaxPixelSize="10000" mergeLines="0" limitNumLabels="0" obstacle="1" scaleVisibility="0" labelPerPart="0" obstacleFactor="1" drawLabels="1" minFeatureSize="0" scaleMax="10000" obstacleType="0" fontLimitPixelSize="0" maxNumLabels="2000" zIndex="0" fontMinPixelSize="3" scaleMin="1" upsidedownLabels="0" displayAll="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penColor="#000000" rotationOffset="270" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" enabled="0" lineSizeType="MM" backgroundAlpha="255" width="15" sizeScale="3x:0,0,0,0,0,0" penAlpha="255" backgroundColor="#ffffff" barWidth="5" scaleDependency="Area" scaleBasedVisibility="1" maxScaleDenominator="10000" penWidth="0" labelPlacementMethod="XHeight" minimumSize="0" minScaleDenominator="-2.14748e+09" height="15" opacity="1" diagramOrientation="Up">
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="TYPE_ROUTE" type="field" width="-1" hidden="0"/>
  ...
  <editable>
    ...
    <field name="TYPE_ROUTE" editable="1"/>
  </editable>
  <labelOnTop>
    ...
    <field name="TYPE_ROUTE" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
